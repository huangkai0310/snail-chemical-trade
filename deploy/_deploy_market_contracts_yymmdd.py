"""Deploy market WS + YYMMDD + contract GC."""
import io
import os
import sys
import tarfile
...
grep -n 'formatYYMMDD\\|onMarketStatus\\|contracts_changed' {REMOTE_SRC}/src/lib/delivery-period.ts {REMOTE_SRC}/src/lib/use-trade-ws.ts {REMOTE_SRC}/src/app/trading/page.tsx | head -20
echo SRC_OK
"""))
