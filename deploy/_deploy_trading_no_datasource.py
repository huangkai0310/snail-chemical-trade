"""Deploy trading hall: remove realtime/warehouse data source toggle."""
import io
import os
import sys
import tarfile
...
grep -n DataSourceSelector {REMOTE_SRC}/src/app/trading/page.tsx && exit 1 || echo NO_SELECTOR_OK
grep -n 'fetchPriceHistory.*exchange' {REMOTE_SRC}/src/app/trading/page.tsx | head -3
"""))
